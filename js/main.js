...
// JavaScript to make the slider functional
...
// Load projects 
  const projectData = [
    ...
    },
    {
      title: "Flappy Bird",
      description:
        "<b  id=\"projectOverview\">Overview: \n</b>This project is a replica of Flappy Bird game and quite similar to dinosaur game of Chrome browser, where a bird keeps jumping until it hits an obstacle. Players control a bird using the spacebar to flap its wings, and the game ends if the bird hits obstacles—pipes placed both above and below. The player's score is based on how many obstacles they successfully pass.\n\n<b id=\"techStack\">Tech Stack:</b> Python,MySQl,Tkinter,Pygame",
    ...
    },
    {
      title: "OnMo Videos",
      description:
        "<b  id=\"projectOverview\">Overview: \n</b>OnMo Videos was a premium video platform developed in multiple technologies. It provided users with a rich library of content, accessible through mobile network billing. With personalized recommendations and multi-device support, it offered a seamless and convenient entertainment experience.However, At present this is not live.\n\n<b id=\"techStack\">Tech Stack:</b> Java,Spring boot, Cloud Search, AWS, RDS",
      thumbnail: "img/Onmovideos_logo2.png",  
    }, {
      title: "Rk Electronics",
      description:
        "<b  id=\"projectOverview\">Overview: \n</b>The RK Electronics project, developed during college term 1, is an e-commerce platform for electronic products. Built using HTML, CSS, and JavaScript, this platform offers a user-friendly interface for browsing and purchasing electronic gadgets.\n\n<b  id=\"techStack\">Tech Stack:</b> HTML,CSS, JavaScript",
  ...
  projectWrapper.querySelector(".arrow-right").addEventListener("click", () => {
    ...
    // Call the autoSlide function to start automatic image changing on load
    // autoSlide();
});
...
//     if (sliderCurrentIndex < slider.children.length - 1) {
//       sliderCurrentIndex++;
//         updateSlider();
//     }
// });
